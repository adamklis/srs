<%@ Page Title="" Language="C#" MasterPageFile="~/index.Master" AutoEventWireup="true" CodeBehind="RezerwacjeUser.aspx.cs" Inherits="SRS.WebForm13" %>
                    ...
                    <td>
                        <asp:GridView ID="gwRezerwacje"  runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False" CellPadding="4" DataKeyNames="Id_Rezerwacja" DataSourceID="sdsRezerwacje" ForeColor="#333333" GridLines="None" HorizontalAlign="Center" OnRowDeleting="gwRezerwacje_RowDeleting">
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="Czas_Od" HeaderText="Od" SortExpression="Czas_Od" />
                                <asp:BoundField DataField="Czas_Do" HeaderText="Do" SortExpression="Czas_Do" />
                        ...
                        <asp:SqlDataSource ID="sdsRezerwacje" runat="server" ConnectionString="<%$ ConnectionStrings:SRSConnectionString %>" SelectCommand="SELECT * FROM [rezerwacje_view] WHERE ([Id_Uzytkownik] = @Id_Uzytkownik)">
                            <SelectParameters>
                                <asp:SessionParameter Name="Id_Uzytkownik" SessionField="id_uzytkownik" Type="Int32" />
                            </SelectParameters>
                        </asp:SqlDataSource>
                    </td>
                </tr>
